...
if __name__ == '__main__': 
    ...
    n_diracs = 10
    cadzow_iter = 20    # choose even number of iterations
    n_jobs = 5
    n_trials = 200
    ...
    plt.legend()
    plt.tight_layout()
    fp = os.path.join(os.path.dirname(__file__), "figures", "_fig2p8a.pdf")
    ...
    plt.legend()
    plt.tight_layout()
    fp = os.path.join(os.path.dirname(__file__), "figures", "_fig2p8b.pdf")
    plt.savefig(fp, dpi=300)
